...
--Inserts admins
--INSERT INTO project.addresses VALUES (DEFAULT,'sente des artistes','1bis',DEFAULT,'4800','Verviers','Belgique');
--INSERT INTO project.users VALUES (DEFAULT,'bert','$2a$10$YnWAR46MkSLTOBR.ptW63uNwsFYSO5aGQ8I/N..Z4mZokFwNShGs.','Satcho','Albert',1,'bert.satcho@gmail.be','2021-03-22',true,2)
--INSERT INTO project.addresses VALUES (DEFAULT,'sente des artistes','18',DEFAULT,'4800','Verviers','Belgique');
--INSERT INTO project.users VALUES (DEFAULT,'lau','$2a$10$BSS3FijyW9M2TZ1brbdSP.nB8Mo6Y/Dx28oHGEdP4MB2SjakYTZvW','Satcho','Laurent',2,'laurent.satcho@gmail.be','2021-03-22',true,2)
--UPDATE project.users SET registration_date = '2021-03-22' WHERE user_id = 2
--UPDATE project.users SET valid_registration = true WHERE user_id = 1
--UPDATE project.users SET user_type = 2 WHERE user_id = 2

--Inserts clients
--INSERT INTO project.addresses VALUES (DEFAULT,'Rue de l'Eglise','11','B1','4987','Stoumont','Belgique');
--INSERT INTO project.users VALUES (DEFAULT,'Caro','$2a$10$Olb5dluFvgTVFW7MhGe6jODO8C6edw9qhkow0X0pYleOYB7HsYQR.','Line','Caroline',3,'caro.line@hotmail.com','2021-03-23',true,1);
--INSERT INTO project.addresses VALUES (DEFAULT,'Rue de Renkin',7',DEFAULT,'4800','Verviers','Belgique');
--INSERT INTO project.users VALUES (DEFAULT,'achil','$2a$10$UKx1LZF5Np1JjgM5mDfsQeth.sNVcKAFHIJtaQA0DvISmNeQz7qeW','Ile','Achille',4,'ach.ile@gmail.com','2021-03-23',true,0);
--INSERT INTO project.addresses VALUES (DEFAULT,'Lammerskreuzstrasse','6',DEFAULT,'52159','Roetgen','Allemagne');
--INSERT INTO project.users VALUES (DEFAULT,'bazz','$2a$10$dwQcHOd5M8OBj6ckqlsfHu6KlKrLVEQzxhyF99iNo9G7F6NSA9C2G','Ile','Basile',5,'bas.ile@gmail.be','2021-03-23',true,0);
--UPDATE project.users SET registration_date = '2021-03-23' WHERE user_id = 5

--Insert demandes de visite
--INSERT INTO project.visit_requests VALUES (DEFAULT,'2021-03-24','lundi de 18h à 22h',4,1,'2021-03-29 20:00:00',DEFAULT,4);
--INSERT INTO project.visit_requests VALUES (DEFAULT,'2021-03-25','lundi de 18h à 22h',4,2,DEFAULT,'Meuble trop récent',4);
--INSERT INTO project.visit_requests VALUES (DEFAULT,'2021-03-25','tous les jours de 15h à 18h',5,1,'2021-03-29 15:00:00',DEFAULT,5);

--Inserts meubles
--INSERT INTO project.furniture VALUES(DEFAULT,'Bahut profond d’une largeur de 112 cm et d’une hauteur de 147cm.',2,1,200,'2021-03-30',DEFAULT,DEFAULT,DEFAULT,DEFAULT,DEFAULT,DEFAULT,1,4,DEFAULT,DEFAULT);
--INSERT INTO project.furniture VALUES(DEFAULT,'Large bureau 1m87 cm, deux colonnes de tiroirs',6,1,159,'2021-03-30',DEFAULT,DEFAULT,DEFAULT,DEFAULT,DEFAULT,DEFAULT,1,4,DEFAULT,DEFAULT);
--INSERT INTO project.furniture VALUES(DEFAULT,'Table jardin en bois brut',21,2,DEFAULT,DEFAULT,DEFAULT,DEFAULT,DEFAULT,DEFAULT,DEFAULT,DEFAULT,1,5,DEFAULT,DEFAULT);
--INSERT INTO project.furniture VALUES(DEFAULT,'Table en chêne, pieds en fer forgé',21,3,140,'2021-03-29',DEFAULT,DEFAULT,DEFAULT,DEFAULT,DEFAULT,DEFAULT,1,4,DEFAULT,DEFAULT);
--INSERT INTO project.furniture VALUES(DEFAULT,'Secrétaire en acajou, marqueterie',20,3,90,'2021-03-29',DEFAULT,DEFAULT,DEFAULT,DEFAULT,DEFAULT,DEFAULT,1,4,DEFAULT,DEFAULT);

--Inserts pictures
--INSERT INTO project.pictures VALUES(DEFAULT, 'Bahut_2.png', false, 1, false);
--INSERT INTO project.pictures VALUES(DEFAULT, 'Bureau_1.png', false, 2, false);
--INSERT INTO project.pictures VALUES(DEFAULT, 'table-jardin-recente.jpg', false, 3, false);
--INSERT INTO project.pictures VALUES(DEFAULT, 'Table.jpg', false, 4, false);
--INSERT INTO project.pictures VALUES(DEFAULT, 'Secretaire.png', false, 5, false);