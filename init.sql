...
CREATE TABLE project.addresses (
	...
	buiding_number VARCHAR(100) NOT NULL,
...
/*
CREATE TABLE projet.visit_requests (
	visit_request_id SERIAL PRIMARY KEY,
	request_date TIMESTAMP NOT NULL,
	time_slot TEXT NOT NULL,
	adress INTEGER REFERENCES projet.addresses (address_id) NULL,
...
CREATE TABLE projet.furniture_types (
...
CREATE TABLE project.furniture (
	...
	type INTEGER REFERENCES project.furniture_type (type_id) NOT NULL,
	visit_request INTEGER REFERENCES projet.visit_requests (visit_request_id) NOT NULL,
	...
	--favorite_picture INTEGER REFERENCES project.pictures (picture_id) NULL
);

CREATE TABLE projet.pictures (
